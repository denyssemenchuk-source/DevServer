  ...
  <div class="min-h-screen bg-gray-50 p-8 font-sans">
    <div class="max-w-[1100px] mx-auto bg-white rounded-xl shadow-sm border border-gray-100 p-6">
      ...
      <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-800">Блог Пости (Адмін-панель)</h1>
...
const { data, pending, refresh } = await useLazyFetch('http://localhost:8000/api/admin/blog/posts')
...
// ВИПРАВЛЕНО: onSelect замість click
