...
class DiggingDeeperController extends Controller
{
    ...
    public function collections()
    {
         ...
         */
        // блог пост це модель даних яку ми використовуємо в базі даних
        // "::" це Оператор розв'язання області видимості
...
//         );
        ...
        $result['map']['all'] = $collection->map(function ($item) {
            $newItem = new \stdClass();// це такий мув щоб шукати цей клас треба в глобальному просторі імен, а не всередині папки твого поточного коду.
